...
public class HandlerUtilsTest {
    ...
    public void testTagsInFirstListButNotInSecond() {
        List<com.amazonaws.kinesisfirehose.deliverystream.Tag> first = ImmutableList
            .of(com.amazonaws.kinesisfirehose.deliverystream.Tag.builder().key("Key0")
                    .value("Value0").build(),
                com.amazonaws.kinesisfirehose.deliverystream.Tag.builder().key("Key1")
                    .value("Value1").build(),
                com.amazonaws.kinesisfirehose.deliverystream.Tag.builder().key("Key2")
                    .value("Value2").build());
        List<String> tagKeysInFirstButNotInSecond = HandlerUtils.tagsInFirstListButNotInSecond(first, null);
        Collections.sort(tagKeysInFirstButNotInSecond);
        assertThat(tagKeysInFirstButNotInSecond).isEqualTo(ImmutableList.of("Key0", "Key1", "Key2"));

        List<com.amazonaws.kinesisfirehose.deliverystream.Tag> second = ImmutableList
            .of(com.amazonaws.kinesisfirehose.deliverystream.Tag.builder().key("Key0")
                    .value("Value20").build(),
                com.amazonaws.kinesisfirehose.deliverystream.Tag.builder().key("Key10")
                    .value("Value11").build());
        tagKeysInFirstButNotInSecond = HandlerUtils.tagsInFirstListButNotInSecond(first, second);
        Collections.sort(tagKeysInFirstButNotInSecond);
        assertThat(tagKeysInFirstButNotInSecond).isEqualTo(ImmutableList.of("Key0", "Key1", "Key2"));
    }
